...
sfile=/gpfs/fs1/home/t/tpaus/jshinb/ukbb_LDL.D_gwas/gwas_script_SNPxSex.sh
...
#INPUT (4):
dirname='UKB_avg.LDL.D_SNPxSex_20211102'
...
# runsfile=/gpfs/fs1/home/t/tpaus/jshinb/ukbb_LDL.D_gwas/run_gwas_script_SNPxSex.sh;sh $runsfile
